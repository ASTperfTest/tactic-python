...
Effects = new function()
{
    ...
    this.tip= function() 
    {
        alert("Effects.tip in compat.js is deprecated");
    ...
    {
        alert("Effects.fade_out in compat.js is deprecated");
        if (time == null)
            time = 1000;
    ...
    {
        alert("Effects.fade_in in compat.js is deprecated");
        if (time == null)
            time = 2000;
         // fading out from 0.8 to 0
    ...
    {
        alert("Effects.css_morph in compat.js is deprecated");
        var dur = 100
        if (time)
            dur = time
    ...
    {
        alert("Effects.css_simple_morph in compat.js is deprecated");
    ...
    {
        alert("Effects.bg_color in compat.js is deprecated");
        this.css_simple_morph(id, class1, 'backgroundColor', 60)
    }

    this.color = function(id, class1)
    {
        alert("Effects.color in compat.js is deprecated");
